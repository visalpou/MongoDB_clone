...
function Body({box_title,box_desc,click_title1,title_1,title_2,desc,btn_title,click_title2}) {
  return(
    <Cover className='grid lg:grid-cols-2 md:grid-cols-6 bg-green-003'>
        <div>
            <div className='flex justify-center translate-y-40 space-x-5'>
                ...
                <p className='text-white-001'> {box_desc} </p>
                <LearnMoreIcon className='text-white-001'>{click_title1} </LearnMoreIcon>
            </div>
            <Title className='translate-y-40 container mx-auto text-white-001 p-28'>
                <h1 className='text-7xl'> {title_1} </h1>
                <h1 className='text-7xl mb-10'> {title_2} </h1>
